    ...
    return (
        <div className="border-b border-[#e2e2e2] h-[48px] flex justify-between items-center pr-[16px] text-[16px]">
            <div className="flex items-center gap-[8px] h-full">
                ...
                <Link to="/execution/audit-program" className={`flex items-center h-full cursor-pointer ml-[10px] no-underline ${(location.pathname === '/execution/audit-program' || location.pathname.startsWith('/execution/audit-program/audit/') || location.pathname === '/execution/observation') ? 'text-[#0f6cbd] font-semibold border-b-[2px] border-[#0f6cbd]' : 'text-gray-400'}`}>Execution</Link>
